...
| `courses.txt`              | Original course-based network data used for community detection. This file represents the network without applying an edge-weight threshold.                                                         |
